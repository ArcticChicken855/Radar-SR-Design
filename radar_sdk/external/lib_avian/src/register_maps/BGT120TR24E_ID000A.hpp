...
const std::map<std::string, NamedMemory<uint16_t, uint32_t>::Address> registers {
    ...
    {"ADC0", {0x0001, 0x000a0200, 0}},
    {"CHIP_ID", {0x0002, 0x00000a00, 0}},
    ...
    {"CLK", {0x005f, 0x00104400, 0}},
    {"WU", {0x0060, 0x00000000, 0}},
