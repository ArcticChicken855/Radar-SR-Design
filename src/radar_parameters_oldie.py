...
R1_params = RadarParameters(center_frequency = 59100E6, bandwidth=1250E6, frame_repetition_time_s=0.1)
R2_params = RadarParameters(center_frequency=60350E6, bandwidth=1250E6, frame_repetition_time_s=0.1)